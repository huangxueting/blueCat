...
@Component
//@Slf4j
public class AesEncodeUtil20260506Train {
     ...
     */
    private static String AES_KEY = "ECJb1QRf76p3ybZb";
     ...
     * @return void
     * @author comtu
     * @date 16:14 2021-09-17
     */
    public static void setAesKey(String aesKey) {
        AES_KEY = aesKey;
    }

//    @Value("${external.AES_KEY}")
...
//         String content = "1000|" + System.currentTimeMillis() + "|gOeoWbEJxGFduoum";
//        String content = "1001|" + System.currentTimeMillis() + "|tmY0rAo102EmnV47";// 对外业务系统使用
        String content = "9999|" + System.currentTimeMillis() + "|08F90EA0DCBA786D";// 数据同步使用
        test(content);
...
//        System.out.println("解密完成后：" + d);
    ...
    static void test(String content) throws UnsupportedEncodingException {
        ...
        System.out.println("转码后: "+content);
